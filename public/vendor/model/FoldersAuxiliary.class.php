...
class FoldersAuxiliary
{
    ...
    public function all($project_id, $folder_id)
    {
        ...
        /** Consulta SQL **/
        $sql = "select * from folders where project_id = :project_id and folder_auxiliary_id = :folder_id";
    ...
    public function save($folder_id, $project_id, $folder_auxiliary_id, $name, $date_register, $date_update)
    {
        ...
        $this->folder_id           = (int)$folder_id;
        $this->project_id          = (int)$project_id;
        $this->folder_auxiliary_id = (int)$folder_auxiliary_id;
        ...
        if ($this->folder_id == 0) {
            ...
            /** Consulta SQL **/
            $sql = "INSERT INTO folders(folder_id, project_id, folder_auxiliary_id, name, date_register, date_update)VALUES(:folder_id, :project_id, :folder_auxiliary_id, :name, :date_register, :date_update)";
        } else {

            /** Consulta SQL **/
            $sql = "UPDATE folders set folder_id = :folder_id, project_id = :project_id, folder_auxiliary_id = :folder_auxiliary_id, name = :name, date_register = :date_register, date_update = :date_update WHERE folder_id = :folder_id";
        }
        ...
        $stmt->bindParam(':folder_id', $this->folder_id);
        $stmt->bindParam(':project_id', $this->project_id);
        $stmt->bindParam(':folder_auxiliary_id', $this->folder_auxiliary_id);
