...
class Situation
{
    ...
    public function editForm($situation_id)
    {
        ...
        /** Consulta SQL **/
        $sql = "select * from situations where situation_id = :situation_id";
    ...
    public function save($situation_id, $name, $description, $date_register, $date_update)
    {
        ...
        if ($this->situation_id == 0) {
            ...
            /** Consulta SQL **/
            $sql = "INSERT INTO situations(situation_id, name, description, date_register, date_update)VALUES(:situation_id, :name, :description, :date_register, :date_update)";
        } else {

            /** Consulta SQL **/
            $sql = "UPDATE situations set situation_id = :situation_id, name = :name, description = :description, date_register = :date_register, date_update = :date_update WHERE situation_id = :situation_id";
        }
    ...
    public function delete($situation_id)
    {
        ...
        /** Consulta SQL **/
        $sql = "DELETE FROM situations WHERE situation_id = :situation_id";
