    ...
    <div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-default mb-0">
            ...
            <a class="navbar-brand" href="#">
                ...
                <i class="far fa-folder-open mr-1"></i>Projetos/Classes/Métodos/Histórico/ <span class="badge badge-primary">Listagem</span>
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="badge badge-primary">
                                        ...
                                        <i class="fas fa-hashtag mr-1"></i>{{result.method_log_id}}
                                ...
                                <nav class="navbar navbar-card navbar-expand-lg navbar-light bg-transparent card-footer">
                                    ...
                                    <button class="navbar-toggler" type="button" data-toggle="collapse" v-bind:data-target="'#navbar_project_' + result.method_id" v-bind:aria-controls="'#navbar_project_' + result.method_id" aria-expanded="false">

                                        <span class="navbar-toggler-icon"></span>

                                    </button>

                                    <div class="collapse navbar-collapse" v-bind:id="'navbar_project_' + result.method_id">

                                        <ul class="navbar-nav mr-auto">

                                            <li class="nav-item">

                                                <router-link v-bind:to="{name : 'classes-datagrid', params : {method_id : result.method_id}}" class="nav-link">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <a class="nav-link" type="button" v-on:click="Restore(result.method_log_id, result.method_id)">
    ...
    export default {
        ...
        methods : {
            ...
            List(){
                ...
                /** Envio de requisição **/
                axios.post('router.php?TABLE=METHOD_LOGS&ACTION=METHOD_LOGS_DATAGRID', {
            ...
            /** Listagem de registros **/
            Restore(method_log_id, method_id){
                ...
                /** identificadores */
                this.inputs.method_id = method_id;
                this.inputs.method_log_id = method_log_id;

                /** Envio de requisição **/
                axios.post('router.php?TABLE=METHOD_LOGS&ACTION=METHOD_LOGS_RESTORE', {
