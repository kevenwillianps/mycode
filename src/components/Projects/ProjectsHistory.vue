    ...
    <div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-default mb-0">
            ...
            <a class="navbar-brand" href="#">
                ...
                <i class="far fa-folder-open mr-1"></i>Projetos/Histórico/ <span class="badge badge-primary">Listagem</span>
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="badge badge-primary">
                                        ...
                                        <i class="fas fa-hashtag mr-1"></i>{{result.project_log_id}}
                                    ...
                                    <div class="collapse navbar-collapse" v-bind:id="'navbar_project_' + result.project_id">
                                        ...
                                        <ul class="navbar-nav mr-auto">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <a class="nav-link" type="button" v-on:click="Restore(result.project_log_id, result.project_id)">
    ...
    export default {
        ...
        methods : {
            ...
            List(){
                ...
                /** Envio de requisição **/
                axios.post('router.php?TABLE=PROJECT_LOGS&ACTION=PROJECT_LOGS_DATAGRID', {
            ...
            /** Listagem de registros **/
            Restore(project_log_id, project_id){
                ...
                this.inputs.project_log_id = project_log_id;

                /** Envio de requisição **/
                axios.post('router.php?TABLE=PROJECT_LOGS&ACTION=PROJECT_LOGS_RESTORE', {
