        ...
        <div class="row">
            ...
            <div class="col-md-6 animate__animated animate__fadeIn">
                ...
                <h4>
                    ...
                    <i class="far fa-folder-open mr-1"></i>Cargos/ <span class="badge badge-primary">Listagem</span>
            ...
            <div class="col-md-6 text-right">
                ...
                <h4>
                    ...
                    <router-link to="/user/functions/form/" class="btn btn-primary">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        mounted(){
            ...
            console.log('Componente "UserFunctionsDatagrid", montado com sucesso!');
