    ...
    <div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-default mb-0">
            ...
            <a class="navbar-brand" href="#">
                ...
                <i class="far fa-folder-open mr-1"></i>Funções de Usuários/ <span class="badge badge-primary">Listagem</span>
            ...
            <div class="collapse navbar-collapse" id="method_navbar_header">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <router-link v-bind:to="{name : 'user-functions-form', params : {user_function_id : 0}}" class="nav-link">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <router-link v-bind:to="{name : 'user-functions-form', params : {user_function_id : result.user_function_id }}" class="nav-link">
    ...
    export default {
        ...
        methods : {
            ...
            Delete(){
                ...
                /** Envio de requisição **/
                axios.post('router.php?TABLE=USER_FUNCTIONS&ACTION=USER_FUNCTIONS_DELETE',{
